...
(13, '236c56', 12, '', '雲林', '面交'),
(14, '236c56', 13, '', '雲林', '面交'),
(15, 'c68678', 14, '', '全台', '面交、郵寄'),
(16, 'c68678', 15, '', '全台', '面交、郵寄'),
(17, 'c68678', 16, '', '全台', '面交、郵寄');
...
('236c56', 'nfucsie02', '', '', '0912345678', '', 'nfucsie02', 'nfucsie02', NULL, '', '嚴選高品質農產品，不使用農藥栽種', 0, 16),
('c68678', 'admin304t', '', 'admin304t@nfucsie.com', '0912345678', '', 'lab304t', 'admin304t', NULL, '', 'admin304t的賣場', 0, 2),
('dec9c9', 'nfucsie01', '', '', '0912345678', '', 'nfucsie01', 'nfucsie01', NULL, '', '販售各式農產，都可以參考看看喔', 0, 39);
...
('admin304t', 'admin304t', 'lab304t', '', 'admin304t@nfucsie.com', '0912345678'),
('admin304u', 'admin304u', 'lab304u', '', 'admin304u@nfucsie.com', '0912345678'),
('nfucsie01', 'nfucsie01', 'nfucsie01', '', '', '0912345678'),
('nfucsie02', 'nfucsie02', 'nfucsie02', '', '', '0912345678');
...
(4, '', '', '把', 30, 150, 0, '葉菜類', 30, '2020-06-21', '空心菜', '彰化', '', '2020-06-18', 0),
...
(14, NULL, '', '把', 20, 150, 0, '蔥蒜類', 20, '2020-06-18', '韭菜', '雲林', '', '2020-06-18', 1),
(15, NULL, '', '把', 30, 140, 0, '莖菜類', 30, '2020-06-18', '筊白筍', '屏東', '', '2020-06-18', 1),
(16, NULL, '', '顆', 45, 100, 1, '葉菜類', 45, '2020-06-18', '茼蒿', '彰化', '', '2020-06-18', 0);
...
(1, 'nfucsie01', '2020-06-20 18:35:02', 'nfucsie01', 'dec9c9', '[{\"CID\":\"6\",\"name\":\"%E5%A4%A7%E7%99%BD%E8%8F%9C\",\"CCash\":\"35\",\"count\":\"1\"}]', 35, '面交', 1);
...
(1, 0, 'ABC123', 'ABC1234567', NULL, '', '0912345678', '123@12.com', '123', '', 0);
...
--
ALTER TABLE `個人賣場2`
  MODIFY `項目` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
-- 使用資料表 AUTO_INCREMENT `產品資訊`
--
ALTER TABLE `產品資訊`
  MODIFY `產品編號` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
-- 使用資料表 AUTO_INCREMENT `訂單`
--
ALTER TABLE `訂單`
  MODIFY `訂單編號` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- 使用資料表 AUTO_INCREMENT `註冊審核`
--
ALTER TABLE `註冊審核`
  MODIFY `編號` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- 使用資料表 AUTO_INCREMENT `配銷方式`
--
ALTER TABLE `配銷方式`
  MODIFY `項目` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
