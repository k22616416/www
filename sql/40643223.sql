...
('', 'admin304t', 'NFU', 'NFU@GMAIL', '', '', 'lab304t', '', NULL, '', '', 0, 15),
('0499fe', 'nfucsie1', '0000000000', 'nfu@csie.com', '0912345678', '', 'nfucsie1', 'nfucsie1', NULL, '', '', 0, 5),
('123456', 'qaz', 'aaa@bbb', 'ccc@ddd', '0912345678', '', '123', '使用者1', NULL, '', 'qewqewqewqewqe', 0, 220),
('654321', 'qwe', 'aaa@bbb', 'ccc@ddd', '0912345678', '', '123', '使用者2', NULL, '', 'qewqewqewqewqe', 0, 46),
...
(19, '', '', '斤', 0, 0, 0, '', 0, '', '產品名稱', '', '', '2020-06-18', 1),
(20, '', '', '斤', 0, 0, 0, '', 0, '', '產品名稱', '', '', '2020-06-18', 1);
...
INSERT INTO `配銷方式` (`訂單編號`, `付款方式`, `配銷地址`, `匯款帳戶`) VALUES
(29, '', '', ''),
(28, '', '', ''),
(27, '', '', ''),
(26, '', '', ''),
...
--
ALTER TABLE `個人賣場2`
  MODIFY `項目` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
-- 使用資料表 AUTO_INCREMENT `產品資訊`
--
ALTER TABLE `產品資訊`
  MODIFY `產品編號` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
-- 使用資料表 AUTO_INCREMENT `訂單`
--
ALTER TABLE `訂單`
  MODIFY `訂單編號` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
--
